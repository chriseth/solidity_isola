...
Find good syntax for pre- and postconditions that should
apply to all functions in the contract.
Modifiers are good candidates for applying pre- and postconditions
to individual functions and because of that, we are thinking
about a clear way to apply a modifier to a whole range of functions.

Some environment variables have a 256 bit unsigned integer type,
...
Other environment variables that come to mind here are
\texttt{block.number},
